# Gmail: finding policy or quote attachments

Use the Gmail MCP connector to find policy or quote attachments in recent email.
...
```
Query: "has:attachment (policy OR quote OR endorsement OR renewal) newer_than:14d"
```
