...
name: month-end-prep
description: >
  Walks an agency owner through month-end close: reconciles QuickBooks against
...
- Same vendor or policyholder name
...
2. **Revenue** — what drove the number; name lines of business or policyholders if
